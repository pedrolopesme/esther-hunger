...
function preload () {
  ...
  game.load.spritesheet('esther', './assets/esther.png', 32, 32)
}
...
function create () {
  ...
  player = game.add.sprite(32, game.world.height - 150, 'esther')
  ...
  for (var i = 0; i < 18; i++) {
    const food = foods.create(i * 60, 0, 'food')
...
function update () {
  ...
  //  Setup collisions for the player, foods, and our platforms
...
function eatFood(player, food) {
  ...
  score += 1
  scoreText.text = 'Esther comeu: ' + score
}